...
export const PERSONAL_LIFE_EVENTS: PersonalLifeEventDefinition[] = [
  ...
  {
    id: "promotion-surprise",
    label: "Reconnaissance inattendue au travail",
    isPositive: true,
    minWealthDelta: 200,
    maxWealthDelta: 600,
    wellbeingDelta: 6,
  ...
  {
    id: "objet-retrouve",
    label: "Objet ou économie oubliée retrouvée",
    isPositive: true,
    minWealthDelta: 150,
    maxWealthDelta: 400,
    wellbeingDelta: 2,
  ...
  {
    id: "conflit-voisinage",
    label: "Conflit de voisinage",
    isPositive: false,
    minWealthDelta: -300,
    maxWealthDelta: -100,
    wellbeingDelta: -5,
  ...
  {
    id: "tracas-administratif",
    label: "Tracas administratif",
    isPositive: false,
    minWealthDelta: -150,
    maxWealthDelta: -50,
    wellbeingDelta: -3,
